...
let getpos pos = (pos.pos_lnum, pos.pos_cnum - pos.pos_bol + 1) 

let printpos (p1,p2) = 
     let p1  = getpos p1 and 
         p2 = getpos p2 in
	  Printf.printf "File \"%s\", line %d, characters %d - %d : \n" !file (fst p1) (snd p1) (snd p2) 


let () =Arg.parse ["--parse_only",Arg.Set parse_only, "Lexer + Parser";
